...
// プロトタイプ宣言
//*****************************************************************************
HRESULT InitializePadX(void);			// パッド初期化
void UpdatePadX(void);
void UninitPadX(void);
...
//ボタン押下状態の取得
BOOL IsButtonPressedX(int padNo, DWORD button)
{
	return (button & g_Controllers[padNo].state.Gamepad.wButtons);
}

//ボタンパルス状態の取得
BOOL IsButtonTriggeredX(int padNo, DWORD button)
{
